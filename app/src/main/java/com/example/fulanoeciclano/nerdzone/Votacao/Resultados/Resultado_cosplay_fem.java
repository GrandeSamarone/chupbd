package com.example.fulanoeciclano.nerdzone.Votacao.Resultados;
...
import com.example.fulanoeciclano.nerdzone.Votacao.Adapter_resultado.Adapter_resultado_cosplay_fem;
        ...
        msgbox.setPositiveButton("Sim",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int wich) {
                        Intent it = new Intent(Resultado_cosplay_fem.this, Lista_cosplay_masc.class);
                        startActivity(it);
                        finish();
                    }
