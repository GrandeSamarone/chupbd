...
import com.example.fulanoeciclano.nerdzone.Votacao.Resultados.Resultado_cosplay_fem;
...
public class Detalhe_cosplay_fem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(categoriaselecionado!=null){
            ...
            LayoutInflater layoutInflater = LayoutInflater.from(Detalhe_cosplay_fem.this);
